...
The SCHEMA Phase II (‘SCHEMA 2.0’) dataset (GRCh38/hg38) contains the analysis of exomes from 87,959 cases and 150,587 controls, and _de novo_ mutations from 3,402 parent-proband trios. Our study has actively recruited from diverse global populations, and includes individuals of European, Latin American, South American, East Asian, Southeast Asian, Ashkenazi Jewish, African, and African American ancestry. Because the sequence data was generated with various capture technologies over a span of a decade, we adapted and developed methods to reduce possible confounders and incorporated this information during the quality control and analysis steps.

The first results of SCHEMA (‘SCHEMA 1.0’) remain available for download on the Downloads page. Later releases are planned with larger number of samples that will further increase power and will be released here before any publication.
...
{ TK: TODO - to be added when authorship list is finalized }
...
## Collections
{ TK: TODO - this section is a work in progress }
...
### Neuropsychiatric Genetics in African Populations (NeuroGAP-Psychosis)
...
### Whole Genome Sequencing of Psychiatric Disorders (WGSPD)
...
<!-- TK: TODO - ask analyst, was this supposed to be removed? -->
