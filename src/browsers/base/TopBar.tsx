...
const TopBarWrapper = styled.div`
  ...
  padding: 10px 30px;
  margin-bottom: 20px;
  background-color: ${(props: TopBarWrapperProps) => props.backgroundColor};
  ...
  ${Link} {
    color: ${(props: TopBarWrapperProps) => props.textColor};
  ...
  ${ToggleMenuButton} {
    border: 1px solid ${(props: TopBarWrapperProps) => props.textColor};
...
const Menu = styled.ul`
  ...
  @media (max-width: 900px) {
    flex-direction: column;
    width: 100%;
    height: ${(props: MenuProps) => (props.isExpanded ? 'auto' : 0)};
