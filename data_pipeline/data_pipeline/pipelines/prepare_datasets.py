...
from data_pipeline.paths import (
    ...
    gp2_combined_variant_annotations_path,
    gp2_combined_variant_results_path,
)
...
def prepare_dataset(dataset_id, test_genes, output_root):
    if dataset_id.lower() == "gp2":
        ...
        combined_variant_results_path = gp2_combined_variant_results_path(output_root, dataset_id)
        combined_variant_annotations_path = gp2_combined_variant_annotations_path(output_root, dataset_id)
        ...
        variant_results.write(dataset_variant_results_path(output_root, dataset_id), overwrite=True)
        ...
        gene_results.write(dataset_gene_results_path(output_root, dataset_id), overwrite=True)
        ...
        ht_clinvar_variants.write(dataset_variant_results_path(output_root, dataset_id), overwrite=True)
        ...
        ht_clinvar_genes.write(dataset_gene_results_path(output_root, dataset_id), overwrite=True)
